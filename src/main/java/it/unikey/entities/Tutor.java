...
public class Tutor extends Persona {
    ...
    static void inserisciTutor() {
        ...
        PersoneUtil.scriviSuFile(nuovoTutor);
        Menu.launchAgain();
    }

    @Override
    public String toString() {
        return "Tutor(nome=" + super.getNome() + ", cognome=" + super.getCognome() + ", dataDiNascita=" + (new SimpleDateFormat("dd/MM/yyyy").format(dataDiNascita)) + ")";
    }
